...
class BaseArray2D(Generic[T]):
    ...
    def __init__(self, gpu_stream: stream_t, nx: int, ny: int, halo_x: int, halo_y: int, data: data_t,
    ...
    def copy_buffer(self, gpu_stream, buffer: Array2D) -> None:
        """
