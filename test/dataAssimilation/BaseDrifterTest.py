...
class BaseDrifterTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.boundaryCondition = BoundaryConditions(BoundaryType.PERIODIC, BoundaryType.PERIODIC,
                                                    BoundaryType.PERIODIC, BoundaryType.PERIODIC)
        self.smallDrifterSet = None
        # to be initialized by child class with the above values
    ...
    def test_set_boundary_condition(self):
        self.set_positions_small_set()
        self.smallDrifterSet.setBoundaryConditions(BoundaryConditions(BoundaryType.PERIODIC, BoundaryType.WALL,
                                                                      BoundaryType.PERIODIC, BoundaryType.WALL))
        bcDict = self.smallDrifterSet.getBoundaryConditions().getBCDict()
        self.assertEqual(bcDict['north'], BoundaryType.PERIODIC)
        self.assertEqual(bcDict['east'], BoundaryType.WALL)
        self.assertEqual(bcDict['south'], BoundaryType.PERIODIC)
        self.assertEqual(bcDict['west'], BoundaryType.WALL)
    ...
    def test_distances(self):
        ...
        self.smallDrifterSet.setBoundaryConditions(BoundaryConditions(BoundaryType.WALL, BoundaryType.WALL,
                                                                      BoundaryType.WALL, BoundaryType.WALL))
        assertListAlmostEqual(self, self.smallDrifterSet.getDistances().tolist(),
                              [longDiag, longLine, longLine], 6,
                              'distances with non-periodic boundaries')

        self.smallDrifterSet.setBoundaryConditions(BoundaryConditions(BoundaryType.WALL, BoundaryType.PERIODIC,
    ...
    def test_gaussian_weights(self):
        ...
        referenceWeights = [3.77361928e-01, 1.22511481e-01, 1.26590824e-04, 3.77361928e-01, 1.22511481e-01,
                            1.26590824e-04]
    ...
    def atest_probabilistic_resampling(self):
        ...
        assert2DListAlmostEqual(self, self.resamplingDrifterSet.getDrifterPositions().tolist(), solutions, 2,
                                "probabilistic resampling, probabilistic duplicates")
    ...
    def atest_residual_sampling(self):
        ...
        assert2DListAlmostEqual(self, self.resamplingDrifterSet.getDrifterPositions().tolist(), solutions, 2,
                                "residual sampling, probabilistic duplicates")
    ...
    def atest_stochastic_universal_sampling(self):
        ...
        assert2DListAlmostEqual(self, self.resamplingDrifterSet.getDrifterPositions().tolist(), solutions, 2,
                                "stochastic universal sampling, probabilistic duplicates")
    ...
    def atest_monte_carlo_metropolis_hasting_sampling(self):
        ...
        assert2DListAlmostEqual(self, self.resamplingDrifterSet.getDrifterPositions().tolist(), solutions, 2,
                                "metropolis hasting sampling, probabilistic duplicates")
