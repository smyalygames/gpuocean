...
class IEWPFOceanTest(unittest.TestCase):
    ...
    def test_localSVD_matrix(self):
        ...
        assert2DListAlmostEqual(self, localSVD_from_GPU.tolist(), self.iewpf.localSVD_host.tolist(), 7,
                                "SVD matrix GPU vs CPU")
        ...
        assert2DListAlmostEqual(self, full_matrix_gpu.tolist(), full_matrix_reference.tolist(), 5,
                                "Full SVD matrix GPU vs file")
    ...
    def test_local_SVD_to_global_CPU_ref_data(self):
        ...
        assert2DListAlmostEqual(self, test_data.tolist(), results_from_file.tolist(), 10,
                                "test_local_SVD_to_global_CPU")
