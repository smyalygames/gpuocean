...
from gpuocean.utils.Common import BoundaryType, BoundaryConditions
...
class BaseDrifterEnsembleTest(unittest.TestCase):
    ...
    def test_probabilistic_resampling(self):
        ...
        assert2DListAlmostEqual(self, self.resamplingParticleSet.observeParticles().tolist(), solutions, 2,
